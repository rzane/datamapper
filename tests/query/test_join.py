...
def test_join_equality_alias() -> None:
    join1 = Join(User, ["pets"], alias="join")
    join2 = Join(User, ["pets"], alias="join")
...
def test_join_inequality_alias() -> None:
    join1 = Join(User, ["pets"], alias="join1")
    join2 = Join(User, ["pets"], alias="join2")
